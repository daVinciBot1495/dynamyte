...
function NodeMap (numNodesPerPartition, numReplicas, hasher) {
	...
	/**
	 * Returns the first node that is responsible for storing the provided
	 * key.
	 *
	 * @param key {String} The key of a key value pair.
	 * @param {Array} The first node that is responsible for storing the
	 * provided key.
	 */
