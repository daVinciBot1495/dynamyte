...
function NodeMap (numReplicas, crypto) {
	...
	/**
	 * Returns whether or not the node map contains the provided node.
	 *
	 * @param node {String} A string representation of a node.
	 * @return {Boolean} Whether or not the node map contains the provided
	 * node.
	 */
	...
	/**
	 * Returns the node that is responsible for storing the provided key.
	 *
	 * @param key {String} The key of a key value pair.
	 * @param {String} The node that is responsible for storing the provided
	 * key.
	 */
